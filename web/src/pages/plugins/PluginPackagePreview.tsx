...
export function PluginPackagePreview({ preview }: { preview: PluginPreviewInfo }) {
  return <section className="mb-4 rounded-xl border border-warning/30 bg-warning-dim p-4 text-sm">
    ...
    <p className="mt-3 text-xs text-text-muted">签名确认包的来源与完整性。安装、权限授权和组件执行分别处理。</p>
  </section>
}
