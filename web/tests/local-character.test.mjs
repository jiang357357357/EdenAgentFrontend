...
test("voice configuration provides a real GSV synthesis service and local devices", () => {
  ...
  assert.match(configurationSource, /inspectLocalGsvConfig\(candidate, stage\)/)
  assert.match(configurationSource, /saveLocalGsvConfig\(gsvForm\)/)
  ...
  assert.match(configurationSource, /previewLocalGsvVoice\(gsvForm, gsvPreviewText\)/)
  ...
  assert.match(configurationSource, /testLocalGsvSttConfig\(sttForm\)/)
  assert.match(configurationSource, /saveLocalGsvSttConfig\(sttForm\)/)
