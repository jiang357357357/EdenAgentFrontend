...
const coreConfig = loadMonConfig(path.resolve(currentDir, "../../../Core"))
...
const authMode = process.env.EDEN_AGENT_AUTH_MODE ?? monConfig.get("auth", "MODE", "production") ?? "production"
